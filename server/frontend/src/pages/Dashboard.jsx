...
const TAB_NAMES = ['SPHERE', 'PARAMS', 'CONTROL'];
                    ...
                    >
                        ...
                        <Box
                            sx={{
                                ...
                                transform: 'rotateY(0deg) translateZ(50px) scale(1.0)',
                                p: 2,
                        ...
                        <Box
                            sx={{
                                ...
                                height: '100%',
                                backfaceVisibility: 'hidden',
                                transform: 'rotateY(120deg) translateZ(50px) scale(1.0)',
                                p: 2,
                                boxSizing: 'border-box',
                                overflow: 'auto',
                            }}
                        ...
                        <Box
                            sx={{
                                ...
                                height: '100%',
                                backfaceVisibility: 'hidden',
                                transform: 'rotateY(240deg) translateZ(50px) scale(1.0)',
                                p: 2,
                                boxSizing: 'border-box',
                                overflow: 'auto',
                            }}
                        >
                            ...
                            >
                                ...
                                {/* System Info */}
                                <Box sx={{ mt: 'auto', pt: 3, borderTop: '1px solid', borderColor: 'primary.main' }}>
                                    <Typography
                                        variant="caption"
                                        sx={{
                                            color: 'primary.main',
